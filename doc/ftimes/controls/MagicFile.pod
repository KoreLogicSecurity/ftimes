...
Note: XMagic is not built into B<FTimes> by default.  If your
version of B<FTimes> does not have this support and the magic field
is requested, B<FTimes> will produce null fields.
