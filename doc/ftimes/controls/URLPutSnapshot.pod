...
B<URLPutSnapshot> is optional.  When enabled, (i.e. 'Y') B<FTimes>
attempts to post the snapshot to an Integrity Server.  Prior
to starting its scan, B<FTimes> will transmit an application layer
