...
The first version of B<FTimes> was written in the Spring of 1999
...
In the Fall of 2001, Exodus Communication, Inc. approved my request
...
utilizes a simple yet effective algorithm that can be applied equally well to different operating systems,
