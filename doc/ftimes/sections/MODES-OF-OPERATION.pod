...
remote shares or mount points.  Any device files specifically
included in the B<list> will be searched (i.e., B<AnalyzeDeviceFiles>
is always enabled in this mode of operation).  Output is written
to stdout and has the following format.
